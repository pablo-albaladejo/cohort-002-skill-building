...
Make personas feel realistic, not stereotypical.`,
    prompt: `Generate a user persona description for this scenario: ${scenarioType.description}

Include: name, occupation, interests, communication preferences, and relevant context.
Output as a natural paragraph description.`,
  });
...
Assistant should be helpful and responsive.`,
    prompt: `Generate a conversation for this scenario: ${scenarioType.description}
